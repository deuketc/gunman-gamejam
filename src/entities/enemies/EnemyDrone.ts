...
const DETECT_HALF_W  = 220;     // half-width of detection rectangle (full width 440px) — two 30% bumps from original 130
const DETECT_HALF_H  = 111;     // half-height (full height 222px) — two 30% bumps from original 65
